                            ...
                            <div class="portlet light portlet-fit portlet-form bordered" id="form_wizard_1">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">修改产品</span>
                                    </div>
                                    <!-- 
                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <form action="#" class="form-horizontal" id="form1">
                                       ...
                                       <input id="product_id" name="product_id" type="hidden" value="${goodsProductInfo.product_id}"/>
                                       <input id="total_stock" name="total_stock" type="hidden" value="${goodsProductInfo.total_stock}"/>
                                       <input id="pre_stock" name="pre_stock" type="hidden" value="${goodsProductInfo.pre_stock}"/>
                                       <input id="rel_stock" name="rel_stock" type="hidden" value="${goodsProductInfo.rel_stock}"/>
                                       <input id="ava_stock" name="ava_stock" type="hidden" value="${goodsProductInfo.ava_stock}"/>
                                       <input id="creator" name="creator" type="hidden" value="${goodsProductInfo.creator}"/>
                                       <input id="create_time" name="create_time" type="hidden" value="${goodsProductInfo.create_time}"/>
                                       <input id="modifyor" name="modifyor" type="hidden" value="${goodsProductInfo.modifyor}"/>
                                       <input id="modify_time" name="modify_time" type="hidden" value="${goodsProductInfo.modify_time}"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-icon right">
                                                        <input type="text" id="product_name" name="product_name" class="form-control" value="${goodsProductInfo.product_name}"/> </div>
                                                </div>
                                            </div>
		    		            ...
		    		            success: function(e) {
	  	    	                ...
	  	    	                submitHandler: function (form) {
	  	    	                    ...
	  	    	                    $("#submit").attr("disabled",1);
	  	    	                     Xhr.cfg("/stock/product/modify/su",{},function(response){
