...
<html lang="zh-cmn-Hans">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-container">
            <!-- BEGIN SIDEBAR -->
            <% request.setAttribute("servlet.menu.sidebar.uri", "/stock/inbound/search") ;%>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="/stock/inbound/search">入库记录</a>
                            </li>
                        </ul>
                         ...
                         <div class="col-md-6">
                             <div class="btn-group">
                                 ...
                                 <button id="sample_editable_1_new" class="btn sbold green" onclick="javascript:BeeModel.openModel('/ams/plan/add/to');"> 新建合同
                                  ...
                                  -->
                                  <button id="sample_editable_1_new" class="btn sbold green" onclick="javascript:BeeModel.openModel('/stock/inbound/add/to');"> 产品入库
                                     <i class="fa fa-plus"></i>
                                 </button>
                             </div>
                         </div>
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
                                       ...
                                       <!--开始表头搜索 --> 
                                       <form class="form-search" action="/stock/inbound/search"> 
	                                       <div class="row">
	                                            <div class="col-md-3">
		                                            <input type="number" placeholder="请输入产品ID.." class="form-control input-sm input-small input-inline" name="productInfo.product_id" value="<c:out value="${goodsStockInbound.productInfo.product_id}"></c:out>">
                                                </div>
                                                <div class="col-md-3">
		                                            <input type="text" placeholder="请输入产品名称.." class="form-control input-sm input-small input-inline" name="productInfo.product_name" value="<c:out value="${goodsStockInbound.productInfo.product_name}"></c:out>">
                                                </div>
	                                            <div class="col-md-6">
														...
														<td > 
														 <div class="btn-group">
	                                                        ...
	                                                        <ul class="dropdown-menu" role="menu">
														        <li><a href="javascript:void();" onclick="javascript:BeeModel.openModel('/stock/inbound/detail/to/${prod[0]}');"><i class="icon-info"></i>入库详情</a></li>
														        <li><a href="javascript:void();" onclick="javascript:invalid('${prod[0]}');"><i class="icon-trash"></i> 设置无效 </a></li>
	                                                        </ul>
	                                                     </div>
														</td>
												     </tr>
	...
	function invalid(id){
		...
		$.ajax({
			type : "POST",
			url : '/stock/inbound/invalid?id='+id,
			success : function(msg) {
			    App.unblockUI();
			    if(msg.code == 200){
					toastr["success"](msg.message, "操作完成");
					setTimeout(function(){
						document.location = "/stock/inbound/search";
					},3000);
			    }else{
