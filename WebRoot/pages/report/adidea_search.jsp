    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase"> 素材报表</span>
                                    </div>
                                    <div class="actions">
                                     ...
                                     <div class="row">
                                            ...
                                            <div class="col-md-2" style="width: 12%;">
                                                   <select class="form-control" name="type" style="" onchange="Page.query();">
                                                        ...
                                                        <option value="2">内部素材</option>
                                                        <option value="1">外部素材</option>
                                                    </select>
                                            </div>
                                             <div class="col-md-2" style="width: 14%;">
	                                             <select id="select2-single-input-sm" class="form-control input-sm select2-multiple" name="ideaId">
	                                                    <option value="">请选择素材...</option>
	                                                    <c:forEach items="${idea_list}" var="idea">
	                                                        <option value="${idea.id}">${idea.idea_name}</option>
	                                                    </c:forEach>
	                                            </select>
                                            </div>
                                             <div class="col-md-2" style="width: 14%;">
      ...
      var Page=(function(){
    	  return {
    		  ...
    		  report:function(){
    			  BeeReport.load("/report/adidea/data",{},function(response){
    		        	//总计
