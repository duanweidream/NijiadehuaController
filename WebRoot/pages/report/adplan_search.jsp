    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase"> 合同报表</span>
                                    </div>
                                    <div class="actions">
                                     ...
                                     <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                   <select class="form-control" name="type" style="" onchange="Page.query();">
                                                        ...
                                                        <option value="2">内部合同</option>
                                                        <option value="1">外部合同</option>
                                                    </select>
                                            </div>
                                            
                                            <div class="col-md-3">
	                                             <select id="select2-single-input-sm" class="form-control input-sm select2-multiple" name="planId">
      ...
      var Page=(function(){
    	  return {
    		  ...
    		  report:function(){
    			  BeeReport.load("/report/adplan/data",{},function(response){
    		        	//总计
