    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                     ...
                                     <div class="row">
                                            ...
                                            <div class="col-md-3">
                                            <select id="select2-single-input-sm" class="form-control input-sm select2-multiple" name="advertiserId">
                                                    <option value="">请选择广告主账号...</option>
                                                    <c:forEach items="${company_list}" var="com">
                                                        <option value="${com.id}"> <c:out value="${com.company_name}"></c:out>  </option>
                                                    </c:forEach>
                                            </select>
                                        </div>
      ...
      var Page=(function(){
    	  return {
    		  ...
    		  report:function(){
    			  BeeReport.load("/report/advertiser/data",{},function(response){
    		        	//总计
