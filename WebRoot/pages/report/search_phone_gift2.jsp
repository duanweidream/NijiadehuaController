    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="javascript:void(0);">流量领取下载</a>
                            </li>
                        </ul>
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">流量领取下载</span>
                                    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body">
                                    <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
                                       <!--开始表头搜索 -->  
                                       <form action="/report/phone/gift2" method="post" id="form1">
                                       <div class="row">
	                                            <div class="col-md-12">
		                                            <label>手机：<input id="phone_number" type="text" name="phone_number" class="form-control  input-small input-inline" placeholder="手机号..." value="${phone_number}" /></label>
                                                    <label>状态：
	                                                    <select id="status" name="status" class="form-control  input-small input-inline">
                                                    ...
                                                    <label>合同：<input id="plan_name" type="text" name="plan_name" class="form-control  input-small input-inline" placeholder="" value="${plan_name}" /></label>
                                                    <label>素材：<input id="idea_name" type="text" name="idea_name" class="form-control  input-small input-inline" placeholder="" value="${idea_name}" /></label>
                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTable dtr-inline" id="sample_1" role="grid" aria-describedby="sample_1_info" style="width: 917px;">
		                                        <thead>
                                                    ...
                                                    <th>
	                                                    <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
	                                                        <input type="checkbox" id="checkbox_all" class="group-checkable"/>
	                                                        <span></span>
	                                                    </label>
	                                                </th>
	                                                --%>
                                             ...
                                             <c:forEach items="${page_list.list }" var="data">
                                                   <tr  class="even">
	                                                   ...
	                                                   <td>
	                                                    <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
	                                                        <input type="checkbox" id="checkbox_${data[9]}" name="idea_sel" value="${data[9]}" class="checkboxes"/>
	                                                        <span></span>
	                                                    </label>
		                                              </td>
		                                              --%>
      ...
      <script src="//static.wooboo.com.cn/theme/assets/global/plugins/bootstrap-toastr/toastr.min.js" type="text/javascript"></script>
	   ...
	   function exportExcel(){
	        ...
	        document.location = "/report/export/excel?sequence=&phone_number="+$("#phone_number").val()+"&status="+$("#status").val()+"&plan_name="+encodeURIComponent(encodeURIComponent($("#plan_name").val()))+"&idea_name="+encodeURIComponent(encodeURIComponent($("#idea_name").val()))+"&bDate="+$("#bDate").val()+"&eDate="+$("#eDate").val();
