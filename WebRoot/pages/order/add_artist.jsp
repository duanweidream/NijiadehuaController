                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">新建艺术家</span>
                                    </div>
                                    <!-- 
                                    <div class="actions">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-icon right">
                                                        <input type="text" id="artist_name" name="artist_name" class="form-control" /> </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-icon right">
                                                        <input type="text" id="real_name" name="real_name" class="form-control" /> </div>
                                                </div>
                                            </div>
		    		            ...
		    		            success: function(e) {
	  	    	                ...
	  	    	                submitHandler: function (form) {
	  	    	                    ...
	  	    	                    $("#submit").attr("disabled",1);
	  	    	                     ...
	  	    	                     Xhr.cfg("/artist/add/su",{},function(response){
