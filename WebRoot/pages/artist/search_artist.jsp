                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">艺术家列表</span>
                                    </div>
                                    <div class="tools"></div>
                                </div>
                                 <!-- END TITLE -->
                                <div class="portlet-body">
                                    <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
                                       ...
                                       <!--开始表头搜索 --> 
                                       <form class="form-search" action="/artist/search"> 
	                                       <div class="row">
	                                            <div class="col-md-6">
		                                            <input type="text" placeholder="请输入艺术家真名.." class="form-control input-sm input-small input-inline" name="real_name" value="<c:out value="${artistInfo.real_name}"></c:out>">
                                                </div>
	                                            <div class="col-md-6">
                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTable dtr-inline">
                                                ...
                                                <tbody>
	                                             ...
	                                             <c:forEach items="${page_list.list}" var="coin">
												     <tr class="odd gradeX">
			                                            <td>${coin.id}</td>
														<td>${coin.real_name}</td>
														<td>${coin.artist_name}</td>
														 ...
														 <div class="btn-group">
	                                                        ...
	                                                        <ul class="dropdown-menu" role="menu">
														        <li><a href="javascript:void();" onclick="javascript:modify('${coin.id}');"><i class="icon-tag"></i> 修改 </a></li>
														        <li><a href="javascript:void();" onclick="javascript:remove('${coin.id}');"><i class="icon-drop"></i> 删除 </a></li>
	                                                        </ul>
	                                                     </div>
														 </td>
												     </tr>
