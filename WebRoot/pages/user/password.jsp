                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green-sharp sbold">密码设置</span>
                                    </div>
                                </div>
                                    ...
                                    <form action="#" class="form-horizontal" id="form1">
                                     ...
                                     <div class="alert alert-danger display-hide">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <input id="notific8_text" type="text" class="form-control" value="${session_user.userName}" placeholder="" disabled /> </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="title">原密码：</label>
                                            <div class="col-md-5">
                                                <input id="password" name="password" type="password" class="form-control" value="" placeholder="" /> </div>
                                        </div>
                                         <div class="form-group">
		    		            ...
		    		            success: function(e) {
	  	    	                ...
	  	    	                submitHandler: function (form) {
	  	    	                    ...
	  	    	                    $("#submit").attr("disabled",1);
	  	    	                     Xhr.cfg("/user/password/update",{},function(response){
