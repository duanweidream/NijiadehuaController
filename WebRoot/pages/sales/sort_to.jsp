...
<div class="modal-header" id="modal-header">
    ...
    <h3 id="myModalLabel">添加|编辑分类信息</h3>
  </div>
   ...
   <form action="#" id="form1" class="form-horizontal" novalidate="novalidate">
                             ...
                             <div class="form-body">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <div class="col-md-6">
                                         <input type="text" name="sortName" value="${menu.sortName}" maxlength="20" class="form-control" />
                                      </div>
                                 </div>
                                 <div class="form-group">
                                     ...
                                     <div class="col-md-6">
                                          <input id="menuSeq" name="sortSeq" type="number" class="form-control" value="${menu.sortSeq}" onkeypress="util.justNum();"/>
