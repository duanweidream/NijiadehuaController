                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="/goods/sales/add/to">新建商品</a>
                            </li>
                        </ul>
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">新建商品</span>
                                    </div>
                                    <!-- 
                                    <div class="actions">
                                       ...
                                       <div class="alert alert-danger display-hide"><button class="close" data-close="alert"></button> 表单验证失败，请检查表单数据! </div>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3">商品分类（书法）:<span class="required"> * </span></label>
                                                <div class="col-md-9">
                                                    <select multiple="multiple" class="multi-select" id="sales_sort" name="sales_sort">
                                                    	<c:forEach items="${salesSort}" var="sales">
															<option value="${sales.id}">${sales.sortName}</option>                                                    		
                                                    	</c:forEach>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-icon right">
                                                        <input type="text" id="sales_name" name="sales_name" class="form-control" /> </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-icon right">
                                                        <input type="text" id="subtitle" name="subtitle" class="form-control" /> </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-icon right">
                                                        <input type="text" id="size" name="size" class="form-control" /> </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-icon right">
                                                        <input type="number" id="mkt_price" name="mkt_price" class="form-control" /> </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-icon right">
                                                        <input type="number" id="sales_price" name="sales_price" class="form-control" /> </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
		    		            ...
		    		            success: function(e) {
	  	    	                ...
	  	    	                submitHandler: function (form) {
	  	    	                    ...
	  	    	                    $("#submit").attr("disabled",1);
	  	    	                     ...
	  	    	                     Xhr.cfg("/goods/sales/add/su",{},function(response){
