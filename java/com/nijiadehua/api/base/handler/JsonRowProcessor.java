 ...
 */
package com.nijiadehua.api.base.handler;
 ...
 */
public interface JsonRowProcessor {
     ...
     */
    <T> T toBean(JSONArray rs, Class<T> type) ;
     ...
     */
    <T> List<T> toBeanList(JSONArray rs, Class<T> type);
     ...
     */
    Map<String, Object> toMap(JSONArray rs) ;
    
    <T> JSONArray toJSONArray(List<T> list);
    
    <T> JSONObject toJSONObject(Object o,Class<T> type);
    
    <T> T toBean(JSONObject rs, Class<T> type);
