...
public class PayController{
	...
	public Result orderquery(Long user_id,String order_id) throws ServiceException{
		log.logInfo("[/v1/pay/orderquery]request:user_id:"+user_id+",order_id:"+order_id);
		...
		try{
			...
			log.logInfo("[/v1/pay/orderquery]response:"+result);
			return new Result(result);
			
		}catch (Exception e) {
			log.logInfo("[/v1/pay/orderquery]error:"+e.getMessage());
			return new Result(ApiError.Type.BUSINESS_ERROR.toException(e.getMessage()));
		}
