package com.wooboo.dsp.base.ftp;
...
import com.wooboo.dsp.system.util.Config;
import com.wooboo.dsp.util.StringUtil;

public class FolderManager {
    private static String baseFolder="/nijiadehua/";
    ...
    public static String getSoundPath(){
    	return baseFolder+"sound/";
    }
    public static String getImgPath(){
    	return baseFolder+"imgIco/";
    }
