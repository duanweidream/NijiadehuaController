...
public class StringUtil {
	...
	public static void main(String[] args) throws Exception{
		...
		String phone = "13121104865";
		String s = phone.replaceAll("(\\d*)\\d{4}(\\d{4})","$1****$2");
		//String s = phone.replaceAll("(\\d*)\\d{4}","$1****");
		//String s = phone.replaceAll("(\\d)(\\d{4})","$1****$2");
		System.out.println(s);
		
		System.out.println(regex("/(ams|process)/.*", "/ams/add/hhhh/"));
		System.out.println(regex("(/ams/.*|/process/.*)", "/ams/add"));
