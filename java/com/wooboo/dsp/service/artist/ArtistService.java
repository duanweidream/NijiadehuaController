package com.wooboo.dsp.service.artist;
...
import com.wooboo.dsp.dao.artist.ArtistDao;
...
public class ArtistService extends BaseService{
	...
	private static Logger log = Logger.getLogger(ArtistService.class);
	
	@Autowired
	private ArtistDao artistDao;
	
	public void searchArtistInfo(ArtistInfo artistInfo,Page page){
		artistDao.searchArtistInfo(artistInfo, page);
	}
	
	public List<ArtistInfo> queryArtistInfo(){
		return artistDao.queryArtistInfo();
	}
